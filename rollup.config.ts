...
function buildExtension(isWeb: boolean, isProd: boolean) {
  return defineConfig({
...
export default process.env.PLATFORM === 'all'
  ? [buildExtension(true, isProd), buildExtension(false, isProd)]
  : buildExtension(process.env.PLATFORM === 'web', isProd)
