...
export const VimNormalKeysPartial :Record<string, NormalKeyAction> = {
  ...
  '<C-u>': (e, {visibleRanges}) => cursorMoveHelper('up', 'line', e.number*visibleRanges[0].>>1),
  '<C-d>': (e, {document:{lineCount}}) => cursorMoveHelper('down', 'line', e.number*lineCount>>1),
  '<C-b>': (e, {document:{lineCount}}) => cursorMoveHelper('up', 'line', e.number*lineCount),
  '<C-f>': (e, {document:{lineCount}}) => cursorMoveHelper('down', 'line', e.number*lineCount),
